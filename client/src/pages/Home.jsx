...
export default function Home() {
  return (
    <div>
      <div id="hero" className='flex flex-col sm:flex-row gap-28 sm:gap-8 items-center justify-center px-8 py-28 lg:px-28 lg:py-36'>
        <div className='flex flex-col w-full gap-6 max-w-2xl order-2 sm:order-1 text-center sm:text-left'>
        ...
        <div className="flex justify-center w-full max-w-lg order-1 sm:order-2">
          <Logo
