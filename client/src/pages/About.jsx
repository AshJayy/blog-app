  ...
  return (
    <div className="min-h-screen flex flex-col p-8 items-center justify-center text-gray-800 dark:text-gray-300">
      <div className="flex flex-col gap-4 max-w-2xl mx-auto text-center">
        <h1 className="text-3xl sm:text-4xl font-semibold mb-3">About</h1>
        <p>Welcome to Ash's Blog! This blog was created by Ashwinie Jayamanna as a personal project to share his thoughts and ideas with the world. </p>
